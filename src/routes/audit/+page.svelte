...
<main class="audit-page" aria-labelledby="audit-hero-title">
				...
				{#each vcRows as r (r.name)}
					<div class="vc-row" role="row">
						...
						<div class="vc-cell vc-col-other" role="cell">
							<span
								class="vc-badge {r.others ? 'vc-badge--ok' : 'vc-badge--no'}"
								aria-label={r.others ? 'Included' : 'Not included'}
							></span>
						</div>
					</div>
				{/each}
	...
	<!-- FAQ -->
	<FAQ items={auditFaqs} title="Audit FAQ" description="Answers to common questions about our audit methodology, timelines, and deliverables." />
